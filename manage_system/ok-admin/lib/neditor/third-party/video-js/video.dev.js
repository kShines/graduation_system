...
document.createElement('static.img.index.video');
 ...
 * @private
 */
vjs.TEST_VID = vjs.createEl('static.img.index.video');
...
vjs.Html5.prototype.createEl = function(){
  ...
  if (!el || this.features['movingMediaElementInDOM'] === false) {
    ...
    if (el) {
      ...
      el = vjs.createEl('static.img.index.video', {
...
if (vjs.IS_OLD_ANDROID) {
  document.createElement('static.img.index.video').constructor.prototype.canPlayType = function(type){
...
vjs.autoSetup = function(){
  var options, vid, player,
      vids = document.getElementsByTagName('static.img.index.video');
